    ...
    def Paint(self, dc=None):
        ...
        if self._hasbkgrd:
            if self._state > 1:
                ...
                gc.Translate(-self._pananchor.x,-self._pananchor.y)
            gc.DrawBitmap(self._CurrentBkgrd, self._bkgrd_origin.x, self._bkgrd_origin.y, self._CurrentBkgrd.GetWidth(), self._CurrentBkgrd.GetHeight())
        ...
        gc.DrawRectangle( self._fixLoc.x-(fovwidth/2.0)-.5, self._fixLoc.y-(fovheight/2.0)-.5, fovwidth, fovheight )
